...
Feature: Verify all functionalities related to Magage Overdraft precise entry screen, it covers CUICE-12227
  ...
  @Sprint9
  Scenario: CUICE-12222 >> Test if content on Manage Overdraft screen are correct after tap on input box
  ...
  @Sprint9
  Scenario: CUICE-12222 >> Test if precise value is being round down to multiple of 10
    Given that user is on precise input box screen
