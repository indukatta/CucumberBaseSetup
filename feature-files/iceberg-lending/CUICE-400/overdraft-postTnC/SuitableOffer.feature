...
Feature: Verify all functionalities related to Suitable Offer screen, it covers CUICE-9953
  ...
  Scenario: CUICE-553 >> Test if content on Suitable Offer screen are correct
    ...
    Then verify that final offer summary "You have been approved and can borrow up to " is displayed
    Then verify that suitable overdraft amount is displayed
  ...
  Scenario: CUICE-553 >> Test if content on Final Offer screen are correct
    ...
    Then verify that Select the Amount screen is visible
