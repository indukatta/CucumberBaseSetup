@amountOfBorrowingNo
Feature: Verify all functionalities related to Amount of Borrowing Info screen, it covers CUICE-6171

  Background: This is to add category to below scenarios
	Given that category "AmountOfBorrowingInfo" is added for below scenarios
  ...
  Scenario: CUICE-6171 >> ATC-004: Test if user is able to see default message on the screen and Okay button
    ...
    And verify that Okay Got it button is displayed on screen
    And verify that Okay Got it button is enabled on screen
